...
```
  ...
  └─────────────────────────────────────┘
                 │
                 ├──> discovery/business-evidence/  ← Phase 1 已写好的 3 类业务证据
                 │
                 ▼
  ┌─────────────────────────────────────┐
...
- 输入：`<NN>-evidence.md` + `discovery/business-evidence/`（3 类证据：comments /
  tests / schema / configs）+ 本节 Outline 行业务-Job 字段。
